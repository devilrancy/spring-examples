# springboot-aws-serverless serverless API
The springboot-aws-serverless project, created with [`aws-serverless-java-container`](https://github.com/awslabs/aws-serverless-java-container).
...
...
Mounting com.vz.StreamLambdaHandler::handleRequest (java8) at http://127.0.0.1:3000/{proxy+} [OPTIONS GET HEAD POST PUT DELETE PATCH]
...
```
    ...
    "Stacks": [
        {
            ...
            "Description": "AWS Serverless Spring API - com.vz::springboot-aws-serverless", 
            "Tags": [], 
            "Outputs": [
                {
                    "Description": "URL for application",
                    "ExportName": "SpringbootAwsServerlessApi",  
                    "OutputKey": "SpringbootAwsServerlessApi",
